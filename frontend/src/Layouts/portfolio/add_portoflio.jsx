...
export function AddPortfolio(){
  ...
  const [selectedImage2, setSelectedImage2] = useState(null);
    ...
    const handleThumbnailChange = (e) => {
        console.log(e.target.name ,"c")
        const selectedFile = e.target.files[0];
        const updatedFormData = { ...formData, thumbnailFile: selectedFile };
    ...
    // };
      ...
      const handleSubmit =  (e) => {
        ...
        e.preventDefault();
    console.log("first :",formData.thumbnailFile,"last :",formData.imageFile)
    console.log((formData.title))
        ...
        axios.post('/portfolio',data)
          ...
          .catch((error) => {
            const apiErrors = error.response.data.errors; // Extract the API's error object
            setErrors(apiErrors);
    ...
    return (
        ...
        >
        <h2 className="text-2xl font-bold text-right">إضافه العمل</h2>
