                  ...
                  <div>
                    <div className="flex justify-between h-fit w-full">
                      <div className="bg-white shadow-lg rounded-lg w-72   ">
                        ...
                        alt="Service" className=" w-full h-44  " />
                        ...
                        <div className="border-t-2 flex  flex-row flex-wrap  justify-between   border-amber-500">
                          <div className="flex flex-row-reverse justify-between place-items-center  w-full ">
                          ...
                          <div className="flex flex-row-reverse w-full place-items-center justify-between m-1.5">
                          <div className=" ">
...
const data = [
  {
    name: "ALi ",
    img: "../assets/freelancer-on-pc.svg",
    title: " اختر العرض المناسب",
    price: 100,
    description:
      "أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه. سيعمل المستقل الذي اخترته معك حتى انتهاء العمل وتسليم مشروعك بشكل كامل كما أردته ",
  },
  {
    name: "saif ",
    img: "../assets/freelancer-on-pc.svg",
    ...
    price: 67,
    description:
      "أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه.أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه.أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه.أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه.أضف تفاصيل مشروعك والمهارات المطلوبة لإنجازه وابدأ باستقبال عروض المستقلين عليه. ",
  },
  {
    name: "ALi Ahmed",
    img: "../assets/freelancer-on-pc.svg",
